    ...
    var child0 = (function() {
      ...
      return {
        ...
        render: function render(context, env, contextualElement, blockArguments) {
          var dom = env.dom;
          var hooks = env.hooks, set = hooks.set, get = hooks.get, subexpr = hooks.subexpr, attribute = hooks.attribute, block = hooks.block;
          dom.detectNamespace(contextualElement);
          var fragment;
          if (env.useFragmentCache && dom.canClone) {
            if (this.cachedFragment === null) {
          ...
          attribute(env, attrMorph0, element0, "class", subexpr(env, context, "if", [get(env, context, "crumb.isCurrent"), "current"], {}));
...
if (runningTests) {
  ...
  require("dummy/app")["default"].create({"name":"ember-breadcrumbs","version":"0.1.7.d2e54856"});
}
